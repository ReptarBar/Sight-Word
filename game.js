...
const sightWordDeck = [
  ...
  { word: 'ball', emoji: '🏀', options: ['ball', 'bell', 'bill', 'bull'] },
  { word: 'milk', emoji: '🥛', options: ['milk', 'silk', 'mile', 'mill'] },
  { word: 'shoe', emoji: '👟', options: ['shoe', 'shore', 'show', 'shoo'] },
  { word: 'train', emoji: '🚂', options: ['train', 'rain', 'tray', 'trail'] },
  { word: 'chair', emoji: '🪑', options: ['chair', 'hair', 'chain', 'chime'] },
  { word: 'house', emoji: '🏠', options: ['house', 'hose', 'mouse', 'horse'] },
  { word: 'bird', emoji: '🐦', options: ['bird', 'board', 'bead', 'beard'] },
  { word: 'cat', emoji: '🐱', options: ['cat', 'cap', 'car', 'can'] },
  { word: 'cow', emoji: '🐄', options: ['cow', 'how', 'now', 'bow'] },
  { word: 'duck', emoji: '🦆', options: ['duck', 'luck', 'deck', 'dock'] },
  { word: 'frog', emoji: '🐸', options: ['frog', 'from', 'fray', 'flag'] },
  { word: 'hand', emoji: '✋', options: ['hand', 'sand', 'hard', 'land'] },
  { word: 'leaf', emoji: '🍃', options: ['leaf', 'loaf', 'leash', 'leak'] },
  { word: 'rain', emoji: '🌧️', options: ['rain', 'train', 'grain', 'ring'] },
  { word: 'moon', emoji: '🌙', options: ['moon', 'moose', 'noon', 'mood'] },
  { word: 'park', emoji: '🌳', options: ['park', 'part', 'pack', 'bark'] },
  { word: 'queen', emoji: '👑', options: ['queen', 'quick', 'quilt', 'quill'] },
  { word: 'ring', emoji: '💍', options: ['ring', 'wing', 'rang', 'rink'] },
  { word: 'ship', emoji: '🚢', options: ['ship', 'shop', 'sheep', 'shin'] },
  { word: 'snow', emoji: '❄️', options: ['snow', 'show', 'slow', 'snore'] },
  { word: 'tent', emoji: '⛺', options: ['tent', 'dent', 'sent', 'tint'] },
  { word: 'zoo', emoji: '🦓', options: ['zoo', 'zero', 'zap', 'boo'] },
  { word: 'farm', emoji: '🚜', options: ['farm', 'form', 'firm', 'fame'] },
  { word: 'grass', emoji: '🌿', options: ['grass', 'glass', 'gross', 'grasp'] },
  { word: 'heart', emoji: '❤️', options: ['heart', 'hear', 'heat', 'hat'] },
  { word: 'light', emoji: '💡', options: ['light', 'night', 'might', 'lift'] },
  { word: 'bike', emoji: '🚴', options: ['bike', 'bake', 'bite', 'hike'] },
  { word: 'music', emoji: '🎵', options: ['music', 'magic', 'muses', 'mouse'] },
  { word: 'water', emoji: '💧', options: ['water', 'waiter', 'later', 'winter'] },
  { word: 'cookie', emoji: '🍪', options: ['cookie', 'bookie', 'cook', 'rookie'] },
  { word: 'panda', emoji: '🐼', options: ['panda', 'pond', 'band', 'panel'] },
  { word: 'lion', emoji: '🦁', options: ['lion', 'line', 'loin', 'lawn'] },
  { word: 'tiger', emoji: '🐯', options: ['tiger', 'tug', 'timer', 'tire'] },
  { word: 'apple', emoji: '🍎', options: ['apple', 'apply', 'ample', 'ale'] },
  { word: 'peach', emoji: '🍑', options: ['peach', 'beach', 'patch', 'peech'] },
  { word: 'grape', emoji: '🍇', options: ['grape', 'grate', 'graph', 'grip'] },
  { word: 'pizza', emoji: '🍕', options: ['pizza', 'pita', 'pizzas', 'pills'] },
  { word: 'robot', emoji: '🤖', options: ['robot', 'rabbit', 'ribbon', 'robin'] },
  { word: 'magic', emoji: '🪄', options: ['magic', 'mango', 'maiden', 'manic'] },
  { word: 'crown', emoji: '👸', options: ['crown', 'clown', 'brown', 'crows'] },
  { word: 'smile', emoji: '😊', options: ['smile', 'slime', 'smite', 'mile'] }
];
